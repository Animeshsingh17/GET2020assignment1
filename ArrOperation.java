package com.metacube.Animeshassignment4;

import java.util.*;

public class ArrOperation {
	/**
	 * method to find largest mirror of integer array
	 * 
	 * 
	 * @param arr
	 *            input integer array
	 * @param n
	 *            size of array
	 * @return integer denotes maximum length of mirror
	 */
	 ...
	 * @param n
	 *            size of array
	 * @return integer denotes maximum number of clumps present
	 */
