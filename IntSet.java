...
public final class IntSet {
	 ...
	 * @param input2 denotes the input array
	 */
	 ...
	 * @param x denotes the number that has to be checked in the set
	 ...
	 * @param arr4 denotes first set
	 * @param arr5 denotes first set
